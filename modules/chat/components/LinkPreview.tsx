...
const LinkPreview = ({ url, className }: LinkPreviewProps) => {
  ...
  return (
    <a
      ...
      className={clsx("mb-2 block p-3 border rounded-lg bg-[#4EF3A6] dark:bg-[#031E0F] border-neutral-200 dark:border-neutral-700 hover:bg-emerald-300 dark:hover:bg-[#052e16] transition-colors", className)}
    >
