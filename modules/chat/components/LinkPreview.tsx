...
const LinkPreview = ({ url, className }: LinkPreviewProps) => {
  ...
  return (
    <a
      ...
      className={clsx("mb-2 block p-3 border rounded-lg bg-[#2CCB88] dark:bg-[#041a12] border-neutral-200 dark:border-neutral-700 hover:bg-emerald-300 dark:hover:bg-[#052e16] transition-colors", className)}
    >
