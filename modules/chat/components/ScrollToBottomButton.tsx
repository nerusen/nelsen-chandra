    ...
    <AnimatePresence>
      {isVisible && (
        <motion.button
          ...
          onClick={onClick}
          className={`fixed bottom-12 left-1/2 transform -translate-x-1/2 z-20 flex h-10 w-10 items-center justify-center rounded-full shadow-lg transition-colors border ${
            isDark
