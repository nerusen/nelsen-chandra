              ...
              <>
                {is_reply && (
                  <>
                    ...
                    {is_pinned && <span className="text-xs text-neutral-700 font-medium ml-2 inline-flex items-center gap-1 align-middle"><PinIcon size={12} /> Pinned</span>}
                  </>
                )}
                {!is_reply && <><MessageRenderer message={message} />{is_pinned && <span className="text-xs text-neutral-700 font-medium ml-2 inline-flex items-center gap-1 align-middle"><PinIcon size={12} /> Pinned</span>}</>}
              </>
            )}
