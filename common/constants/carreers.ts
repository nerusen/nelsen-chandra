...
export const CAREERS: CareerProps[] = [
  {
    ...
    company: "Nerusen Design",
    logo: "/images/careers/nerusen.png",
    ...
    end_date: null,
    industry: "Design",
    link: "https://nelsen.my.id/",
    responsibilities: [
      "Memahami visi, tujuan, dan target audiens klien.",
      "Menganalisis pesaing dan tren industri untuk mengumpulkan wawasan.",
      "Tetapkan tujuan, hasil, dan jadwal proyek.",
    ],
    isShow: true,
  },
  {
